...
const AboutES = {
    ...
    <main>
        <article>
            <h2 id="h2-title" class="text-center m-4">What is Emscripten?</h2>
            <p class="text-center m-4 p-2 bg-body-secondary">
            ...
            <h3 id="h3-title" class="text-left m-4">Early days (2010-2011)</h3>
            <p class="text-center m-4 p-2 bg-body-secondary">
			...
			<h3 id="h3-title" class="text-right m-4">Development and growth (2011-2013)</h3>
            <p class="text-center m-4 p-2 bg-body-secondary">
            ...
            <h3 id="h3-title" class="text-left m-4">WebAssembly (2015)</h3>
            <p class="text-center m-4 p-2 bg-body-secondary">
            ...
            <h3 id="h3-title" class="text-right m-4">Modern Emscripten (2016-present)</h3>
            ...
            <h3 id="h3-title" class="text-left m-4">Emscripten's Uses</h3>
            <div class="text-center m-4 p-2 bg-body-secondary">
